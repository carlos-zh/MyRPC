...
public class TestClient {
    public static void main(String[] args) {
        ...
        // 方式一：在实现InvocationHandler的类中定义一个方法创建代理对象
//        UserService userService = rpcClientProxy.getProxy(UserService.class);
        // 方式二：直接调用Proxy.newProxyInstance()创建代理对象
//        UserService userService = (UserService) Proxy.newProxyInstance(UserServiceImpl.class.getClassLoader(), new Class[]{UserService.class}, rpcClientProxy);
        UserService userService = (UserService) Proxy.newProxyInstance(UserService.class.getClassLoader(), new Class[]{UserService.class}, rpcClientProxy);
        // 调用方法
